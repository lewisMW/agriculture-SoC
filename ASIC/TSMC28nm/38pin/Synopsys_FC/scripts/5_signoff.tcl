...
write_verilog -top_module_first -hierarchy all \
	-exclude {leaf_module_declarations empty_modules corner_cells filler_cells flip_chip_pad_cells pad_spacer_cells pg_netlist spare_cells} $OUT_DIR/nanosoc_chip_pads_gate.v
write_verilog -top_module_first -hierarchy all \
	-exclude {leaf_module_declarations empty_modules corner_cells filler_cells flip_chip_pad_cells pad_spacer_cells spare_cells} $OUT_DIR/nanosoc_chip_pads_gate_power.v
