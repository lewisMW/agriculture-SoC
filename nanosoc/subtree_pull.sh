...
git subtree pull --prefix=nanosoc/nanosoc_tech https://git.soton.ac.uk/soclabs/nanosoc_tech.git main --squash
git subtree pull --prefix=nanosoc/rtl_primitives_tech https://git.soton.ac.uk/soclabs/rtl_primitives_tech.git main --squash
