...
set lib_path_list [list ../libs/cln28ht/ ../libs/cln28ht_pmk/ ../libs/cln28ht_hpk/  ../libs/sram_16k/  ../libs/rom_via/ ../libs/io_lib/ ../libs/pad_lib/ ../libs/Synopsys_PD ../libs/Synopsys_TS ../libs/Synopsys_VM ]
set lib_list {cln28ht cln28ht_pmk cln28ht_hpk sram_16k rom_via io_lib pad_lib Synopsys_PD Synopsys_TS Synopsys_VM} 
...
set Synopsys_PD_FORMALITY $Synopsys_PD_dir/db/mr74125_tc_vtyp_25c.db  
set Synopsys_TS_FORMALITY $Synopsys_TS_dir/db/mr74127_tc_vtyp_25c.db   


set formality_ref_libs_list [list $TSMC_IO_FORMALITY $SRAM_16K_FORMALITY $ROM_FORMALITY $Synopsys_PD_FORMALITY $Synopsys_TS_FORMALITY]
set formality_imp_libs_list [list \
    ...
    $PMK_FORMALITY \
    $HPK_FORMALITY \
    $Synopsys_PD_FORMALITY \
    $Synopsys_TS_FORMALITY \
]
