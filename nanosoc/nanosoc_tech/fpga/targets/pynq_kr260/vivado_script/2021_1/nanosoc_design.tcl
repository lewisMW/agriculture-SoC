...
proc create_hier_cell_cmsdk_socket { parentCell nameHier } {
  ...
  connect_bd_net -net not_rpimodex8 [get_bd_pins not_rpi_enable9/dout] [get_bd_pins zynq_extio_o/Op1] [get_bd_pins zynq_extio_i_maskx8/Op1] [get_bd_pins zynq_extio_z/Op2] [get_bd_pins zynq_p0_o/Op1]
  ...
  connect_bd_net -net rpimodex8 [get_bd_pins rpi_enable8/dout] [get_bd_pins rpi_p0_o/Op1] [get_bd_pins rpi_extio_o/Op1] [get_bd_pins rpi_extio_z/Op2]
...
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {39.473682} \
