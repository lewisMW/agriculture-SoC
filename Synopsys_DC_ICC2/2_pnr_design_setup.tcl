...
set_app_var link_library $pnr_lib_list

create_lib ${lib_name} -technology $tech_file -ref_libs $pnr_lef_list

read_verilog -library ${lib_name} -design $top_module -top $top_module $OUT_DIR/${top_module}.vp
link_block
